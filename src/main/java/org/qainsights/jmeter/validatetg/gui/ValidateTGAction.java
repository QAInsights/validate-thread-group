...
class ValidateTGAction extends AbstractAction {
    ...
    public static final KeyStroke VALIDATE_ALL_TG   = KeyStroke.getKeyStroke(KeyEvent.VK_V, InputEvent.ALT_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK);
    ...
    ValidateTGAction() {
        ...
        putValue(Action.ACCELERATOR_KEY, VALIDATE_ALL_TG);
